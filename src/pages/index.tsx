...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Pol-Land</title>
        <meta name="description" content="Pol-Land" />
        ...
        <div className="pt-5 pb-20 mx-auto max-w-7xl">
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
            <FeatureCard
              ...
              desc="The Polygon chain has SPoS consensus which enables 17 UN SDGs to drive ESG with better approach. That's where government agrees on common ground."
            />
            <FeatureCard
